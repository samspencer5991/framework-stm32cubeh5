...
The **STM32CubeH5 MCU Package** projects are directly running on the STM32H5 series boards. You can find in each Projects/*Board name* directories a set of software projects (Applications/Demonstration/Examples).
